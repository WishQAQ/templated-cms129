...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<a class=\"page_button\" href='javascript:;'><<</a> <a class=\"page_item_current\">1</a> <a class=\"page_button\" href='javascript:;'>>></a>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<a class=\"page_button\" href='javascript:;'><<</a> <a class=\"page_item_current\">0</a> <a class=\"page_button\" href='javascript:;'>>></a>\r\n";
        }
        $purl = $this->GetCurUrl();
        $maininfo = "<a class=\"page_button\" href='javascript:;'><<</a> <a class=\"page_item_current\">".$this->TotalResult."</a> <a class=\"page_button\" href='javascript:;'>>></a>\r\n";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class=\"page_button\" href='".str_replace("{page}",$prepagenum,$tnamerule)."'><<</a>\r\n";
        ...
        {
            $nextpage.="<a class=\"page_button\" href='".str_replace("{page}",$nextpagenum,$tnamerule)."'>>></a>\r\n";
...
$listdd.="<a class=\"page_item\" href=\"".str_replace("{page}",$j,$tnamerule)."\">".$j."</a>\r\n";
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            return "<a class=\"page_button\" href='javascript:;'><<</a> <a class=\"page_item_current\">".$this->TotalResult."</a> <a class=\"page_button\" href='javascript:;'>>></a> \r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<a class=\"page_button\" href='javascript:;'><<</a>  <a class=\"page_item_current\">".$this->TotalResult."</a> <a class=\"page_button\" href='javascript:;'>>></a>\r\n";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class=\"page_button\" href='".$purl."PageNo=$prepagenum'><<</a>\r\n";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a class=\"page_button\" href='".$purl."PageNo=$nextpagenum'>>></a>\r\n";
